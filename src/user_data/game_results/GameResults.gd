...
func get_all_indexed() -> Array[GameResultMetadata]:
	return _index_cache.metadata_list


func save(result: SingleplayerGameResult) -> void:
...
func load(path: String) -> SingleplayerGameResult:
...
func _do_index_file(file_idx: String, file_path: String, result: SingleplayerGameResult) -> void:
